...
Table                Purpose
events               Raw inputs with timestamps
normalized_records   Structured inputs
decisions            VERDICT outputs
execution_tasks      APEX task definitions
runs                 Execution logs
messages             RELAY communications
artifacts            Outputs and files
metrics              OBSERVE tracking
risk_logs            RISK enforcement
economics            ECON tracking
